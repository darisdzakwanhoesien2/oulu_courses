...
class Win(GlutWindow):
	...
	def init_context(self):
		# Read shader files
		vertex_shader_source = read_file("shaders/vertex_shader.glsl")
		fragment_shader_source = read_file("shaders/fragment_shader.glsl")

		# Compile vertex and fragment shaders
		vertex_shader = shaders.compileShader(vertex_shader_source, GL_VERTEX_SHADER)
		fragment_shader = shaders.compileShader(fragment_shader_source, GL_FRAGMENT_SHADER)

		# Create program object manually
		...
		# Bind attribute locations manually
